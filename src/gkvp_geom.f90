...
!    --------------
!      gkvp_f0.62 (S. Maeyama, March 2022)
...
!          and from gkvp_shearflow.f90 for update in rotating flux-tube model.
...
! for tokamak(eqdsk) equilibrium
  ...
  public   geom_read_nml, geom_init_kxkyzvm, &
           geom_init_metric, geom_set_operators, &
           geom_reset_time, geom_increment_time
